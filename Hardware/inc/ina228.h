...
typedef enum
{
	...
	Clears_ACC_Values = 0x01 // Clears registers to default values for ENERGY and CHARGEregisters
} INA228_Config_ResACC_enum;

// Sets the Delay for initial ADC conversion in steps of 2 ms,  bit 13-6
typedef enum
{
	Init_Delay_Time_0s = 0x00,	 //
	Init_Delay_Time_2ms = 0x01,	 //
	Init_Delay_Time_510ms = 0xFF //

} INA228_Config_Init_Delay_Conver_enum;
...
} INA228_Config_Temperature_enum;
